...
class DockerDebugModeAzureProvider : RiderDockerDebugProvider {
    companion object {
        ...
        private const val AZURE_FUNCTIONS_ENV_VAR = "AzureWebJobsScriptRoot"
    ...
    override fun isApplicable(
        ...
        if (projectProperties != null && projectProperties.isAzureFunctionsProject) return true

        val imageProperties = deploymentModel.getImageProperties()
        return imageProperties?.envs?.containsKey(AZURE_FUNCTIONS_ENV_VAR) == true
    }
