...
import com.microsoft.azure.toolkit.intellij.appservice.docker.statistics.RiderDockerStatisticsCollector
...
internal class DockerDebugModeAzureTransformer : RiderDockerDeploymentTransformer {
    ...
    override suspend fun transformConfig(
        ...
        val debugModeInfo = DockerDebugModeAzureService
            ...
            .prepareDebugMode(deploymentParams, transformedParams)
        ...
        val entrypoint = debugModeInfo.getDebuggerEntrypoint()
        ...
        RiderDockerStatisticsCollector.debuggerStartUp(
            debugModeInfo.debugProvider.debuggerTargetType,
    ...
    override suspend fun patchComposeServices(
        ...
        val debugModeInfos = DockerDebugModeAzureService
            .getInstance(deploymentTask.project)
            .prepareDebugMode(servicesToProcess, patchedParams)
    ...
    private fun saveDebugInfoToEnvironment(
        ...
        val debugConnectorInfo = RiderDockerDebugConnectorInfo(
            ...
            deploymentTransformedParams.getExecutionCommand(debugModeInfo.containerOs)
                ?: dockerDeploymentModel.getExecutionCommand(),
            debugModeInfo.containerOs,
    ...
    private fun saveDebugInfoToEnvironment(
        ...
        for ((service, debugModeInfo) in debugModeInfos) {
            ...
            val serviceDebugConnectorInfo = RiderDockerDebugConnectorInfo(
                ...
                servicePatchedParams?.getExecutionCommand(debugModeInfo.containerOs)
                    ?: deploymentModel.getExecutionCommand(),
                debugModeInfo.containerOs,
                debugModeInfo.containerDotnetVersion
            )
    ...
    private suspend fun patchComposeService(
        serviceName: String,
