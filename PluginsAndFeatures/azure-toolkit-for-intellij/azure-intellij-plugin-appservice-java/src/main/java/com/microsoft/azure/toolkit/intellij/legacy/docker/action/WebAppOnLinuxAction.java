...
public class WebAppOnLinuxAction extends WebAppOnLinuxActionBase {
    private final AzureDockerSupportConfigurationType configType = AzureDockerSupportConfigurationType.getInstance();

    @Override
    protected ConfigurationFactory getWebAppOnLinuxDeployConfigurationFactory() {
        return configType.getWebAppOnLinuxDeployConfigurationFactory();
    }
}
